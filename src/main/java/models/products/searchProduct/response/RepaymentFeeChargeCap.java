...
public class RepaymentFeeChargeCap {
    ...
    private List<OtherFeeType__6> otherFeeType = null;
    @JsonIgnore
    ...
    @JsonProperty("otherFeeType")
    public List<OtherFeeType__6> getOtherFeeType() {
        return otherFeeType;
    }

    @JsonProperty("otherFeeType")
    public void setOtherFeeType(List<OtherFeeType__6> otherFeeType) {
