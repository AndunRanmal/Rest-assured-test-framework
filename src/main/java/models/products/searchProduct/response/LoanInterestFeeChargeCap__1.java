...
public class LoanInterestFeeChargeCap__1 {
    ...
    private List<OtherFeeType__2> otherFeeType = null;
    @JsonIgnore
    ...
    @JsonProperty("otherFeeType")
    public List<OtherFeeType__2> getOtherFeeType() {
        return otherFeeType;
    }

    @JsonProperty("otherFeeType")
    public void setOtherFeeType(List<OtherFeeType__2> otherFeeType) {
